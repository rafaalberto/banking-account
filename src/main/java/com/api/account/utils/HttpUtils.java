...
public final class HttpUtils {
  ...
  public static String getQueryParameter(final HttpServerExchange exchange) {
  ...
  public static void handleStatusAndHeaders(
      final HttpServerExchange exchange, final int httpCreatedStatus) {
  ...
  public static void handleApplicationException(
      final HttpServerExchange exchange, final BusinessException e) {
    try {
  ...
  public static void handleApplicationException(
      final HttpServerExchange exchange, final Exception e) {
    try {
      exchange.setStatusCode(HTTP_SERVER_ERROR);
      exchange
          .getResponseSender()
          .send(convertToJson(new Message(false, "Error, please contact the support")));
